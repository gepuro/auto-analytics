...
root_agent = LlmAgent(
    ...
    instruction=(
        ...
        "**1. リクエストの解釈 / Tool `request_interpreter`**: ユーザーのリクエストが不明確なら、toolを利用してください。\n"
        "**2. テーブル探索とスキーマ・サンプル確認 / Tool `table_and_sameple_explorer`**: 分析対象のテーブルを特定する必要があったら、toolを利用してください。\n"
