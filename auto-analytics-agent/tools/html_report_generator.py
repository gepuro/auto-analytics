...
class HTMLReportGenerator:
    ...
    def __init__(self, template_dir: Optional[str] = None, output_dir: Optional[str] = None):
        ...
        if output_dir is None:
            ...
            current_dir = Path(__file__).parent
            workspace_root = current_dir.parent.parent  # Go up from tools/ -> auto-analytics-agent/ -> workspace/
    ...
    def generate_report(
        ...
        try:
            ...
            result = {
                ...
                'generation_time': report_data.get('generation_time', datetime.now().strftime("%Y年%m月%d日 %H:%M:%S"))
            }
    ...
    def _prepare_report_data(self, analysis_data: Dict[str, Any], custom_title: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        report_data = {
            ...
            'report_title': custom_title or analysis_data.get('title', 'データ分析レポート'),
        ...
        if 'recommendations' in analysis_data:
            report_data['recommendations'] = self._format_recommendations(analysis_data['recommendations'])
...
ORDER BY month'''
        ...
        'query_execution_result': {
            'data': [
                {'month': '2024-01-01', 'total_sales': 1500000, 'transaction_count': 250},
                {'month': '2024-02-01', 'total_sales': 1750000, 'transaction_count': 300},
                {'month': '2024-03-01', 'total_sales': 2100000, 'transaction_count': 350}
            ]
        },
